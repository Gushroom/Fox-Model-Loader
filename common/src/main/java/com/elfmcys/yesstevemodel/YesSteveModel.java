...
public class YesSteveModel {
    ...
    private static void initConfig() {
        ...
        ConfigRegistration.register(MOD_ID, ConfigRegistration.Type.CLIENT, GeneralConfig.buildSpec());
        ConfigRegistration.register(MOD_ID, ConfigRegistration.Type.SERVER, ServerConfig.buildSpec());
